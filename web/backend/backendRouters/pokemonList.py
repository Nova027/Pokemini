...
# To be replaced later with {"team-list": []}, ie, no teams created.
defaultData = {
    "team-list": ["team-1"],
    "team-1": ["Pikachu", "Charizard"]
}
...
async def get_users(guest_id: str = Depends(get_guest_id)):
    filename = WEB_DIR / "playerData" / f"teamData_{guest_id}.json"
    
    # Create the file if it doesn't exist yet, with empty dict.
